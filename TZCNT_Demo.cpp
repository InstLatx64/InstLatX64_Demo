...
void TZCNT_Test(void) {
	...
	cout << "_mm_tzcnt_epi8_asm            :" << (double)_mm_tzcnt_epi8_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm_tzcnt_epi16_asm           :" << (double)_mm_tzcnt_epi16_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm_tzcnt_epi32_asm           :" << (double)_mm_tzcnt_epi32_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm_tzcnt_epi64_asm           :" << (double)_mm_tzcnt_epi64_asm_timed() / (double)TZCNT_REPEATS << endl;

	cout << "_mm256_tzcnt_epi8_asm         :" << (double)_mm256_tzcnt_epi8_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm256_tzcnt_epi16_asm        :" << (double)_mm256_tzcnt_epi16_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm256_tzcnt_epi32_asm        :" << (double)_mm256_tzcnt_epi32_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm256_tzcnt_epi64_asm        :" << (double)_mm256_tzcnt_epi64_asm_timed() / (double)TZCNT_REPEATS << endl;

	cout << "_mm512_tzcnt_epi8_asm         :" << (double)_mm512_tzcnt_epi8_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm512_tzcnt_epi16_asm        :" << (double)_mm512_tzcnt_epi16_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm512_tzcnt_epi32_asm        :" << (double)_mm512_tzcnt_epi32_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm512_tzcnt_epi64_asm        :" << (double)_mm512_tzcnt_epi64_asm_timed() / (double)TZCNT_REPEATS << endl;

	cout << "_mm_tzcnt_epi32_cd_asm        :" << (double)_mm_tzcnt_epi32_cd_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm256_tzcnt_epi32_cd_asm     :" << (double)_mm256_tzcnt_epi32_cd_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm512_tzcnt_epi32_cd_asm     :" << (double)_mm512_tzcnt_epi32_cd_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm_tzcnt_epi64_cd_asm        :" << (double)_mm_tzcnt_epi64_cd_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm256_tzcnt_epi64_cd_asm     :" << (double)_mm256_tzcnt_epi64_cd_asm_timed() / (double)TZCNT_REPEATS << endl;
	cout << "_mm512_tzcnt_epi64_cd_asm     :" << (double)_mm512_tzcnt_epi64_cd_asm_timed() / (double)TZCNT_REPEATS << endl;
}
