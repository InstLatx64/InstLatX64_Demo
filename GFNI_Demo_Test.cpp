...
void GFNI_Demo_rotatev_epi8(void) {
	...
	__m128i test128	= _mm_xor_si128(x128, _mm_rolv_gfni_epi8(_mm_rorv_gfni_epi8(x128, y128), y128));
	assert(_mm_testz_si128(test128, test128));

	printRes("x128                               ", x128);
	printRes("y128                               ", y128);
	printRes("_mm_rorv_gfni_epi8(x128, y128)     ", _mm_rorv_gfni_epi8(x128, y128));
	printRes("_mm_rolv_gfni_epi8(x128, y128)     ", _mm_rolv_gfni_epi8(x128, y128));

#if defined(__AVX512F__)
	__m128i full128 = _mm_set1_epi32(0xffffffff);
	printRes("_mm_maskz_rorv_gfni_epi8           ", _mm_maskz_rorv_gfni_epi8((__mmask16)0xaa55, x128, y128));
	printRes("_mm_mask_rorv_gfni_epi8            ", _mm_mask_rorv_gfni_epi8(full128, (__mmask16)0xaa55, x128, y128));
	printRes("_mm_maskz_rolv_gfni_epi8           ", _mm_maskz_rolv_gfni_epi8((__mmask16)0xac35, x128, y128));
	printRes("_mm_mask_rolv_gfni_epi8            ", _mm_mask_rolv_gfni_epi8(full128, (__mmask16)0xac35, x128, y128));
#endif
#if defined(__AVX2__)
	...
	__m256i test256	= _mm256_xor_si256(x256, _mm256_rolv_gfni_epi8(_mm256_rorv_gfni_epi8(x256, y256), y256));
	assert(_mm256_testz_si256(test256, test256));

	printRes("x256                               ", x256);
	printRes("y256                               ", y256);
	printRes("_mm256_rorv_gfni_epi8(x256, y256)  ", _mm256_rorv_gfni_epi8(x256, y256));
	printRes("_mm256_rolv_gfni_epi8(x256, y256)  ", _mm256_rolv_gfni_epi8(x256, y256));

#if defined(__AVX512F__)
	__m256i full256 = _mm256_set1_epi32(0xffffffff);
	printRes("_mm256_maskz_rorv_gfni_epi8        ", _mm256_maskz_rorv_gfni_epi8((__mmask32)0xcc33aa55, x256, y256));
	printRes("_mm256_mask_rorv_gfni_epi8         ", _mm256_mask_rorv_gfni_epi8(full256, (__mmask32)0xcc33aa55, x256, y256));
	printRes("_mm256_maskz_rolv_gfni_epi8        ", _mm256_maskz_rolv_gfni_epi8((__mmask32)0xac35f0a50f, x256, y256));
	printRes("_mm256_mask_rolv_gfni_epi8         ", _mm256_mask_rolv_gfni_epi8(full256, (__mmask32)0xac35f0a50f, x256, y256));
	...
	__mmask64 test512	= _mm512_cmpeq_epi8_mask(x512, _mm512_rolv_gfni_epi8(_mm512_rorv_gfni_epi8(x512, y512), y512));
	assert(test512);

	printRes("x512                               ", x512);
	printRes("y512                               ", y512);
	printRes("_mm512_rorv_gfni_epi8(x512, y512)  ", _mm512_rorv_gfni_epi8(x512, y512));
	printRes("_mm512_rolv_gfni_epi8(x512, y512)  ", _mm512_rolv_gfni_epi8(x512, y512));

	__m512i full512 = _mm512_set1_epi32(0xffffffff);
	printRes("_mm512_maskz_rorv_gfni_epi8        ", _mm512_maskz_rorv_gfni_epi8((__mmask64)0xcc33aa55cc33aa55, x512, y512));
	printRes("_mm512_mask_rorv_gfni_epi8         ", _mm512_mask_rorv_gfni_epi8(full512, (__mmask64)0xcc33aa55cc33aa55, x512, y512));
	printRes("_mm512_maskz_rolv_gfni_epi8        ", _mm512_maskz_rolv_gfni_epi8((__mmask64)0xf00faa5533ccff00, x512, y512));
	printRes("_mm512_mask_rolv_gfni_epi8         ", _mm512_mask_rolv_gfni_epi8(full512, (__mmask64)0xf00faa5533ccff00, x512, y512));
#endif
#endif
}

void GFNI_Demo_shiftv_epi8(void) {
	...
	__m128i temp128 = _mm_or_si128(_mm_srlv_gfni_epi8(x128, y128), _mm_sllv_gfni_epi8(x128, _mm_sub_epi8(_mm_set1_epi32(0x08080808), y128)));
	__m128i test128	= _mm_xor_si128(x128, _mm_or_si128(_mm_sllv_gfni_epi8(temp128, y128), _mm_srlv_gfni_epi8(temp128, _mm_sub_epi8(_mm_set1_epi32(0x08080808), y128))));
	assert(_mm_testz_si128(test128, test128));

	printRes("x128                               ", x128);
	printRes("y128                               ", y128);
	printRes("_mm_sllv_gfni_epi8(x128, y128)     ", _mm_sllv_gfni_epi8(x128, y128));
	printRes("_mm_srlv_gfni_epi8(x128, y128)     ", _mm_srlv_gfni_epi8(x128, y128));

#if defined(__AVX512F__)
	__m128i full128 = _mm_set1_epi32(0xffffffff);
	printRes("_mm_maskz_sllv_gfni_epi8           ", _mm_maskz_sllv_gfni_epi8((__mmask16)0xac35, x128, y128));
	printRes("_mm_mask_sllv_gfni_epi8            ", _mm_mask_sllv_gfni_epi8(full128, (__mmask16)0xac35, x128, y128));
	printRes("_mm_maskz_srlv_gfni_epi8           ", _mm_maskz_srlv_gfni_epi8((__mmask16)0xaa55, x128, y128));
	printRes("_mm_mask_srlv_gfni_epi8            ", _mm_mask_srlv_gfni_epi8(full128, (__mmask16)0xaa55, x128, y128));
#endif
#if defined(__AVX2__)
	...
	__m256i temp256 = _mm256_or_si256(_mm256_srlv_gfni_epi8(x256, y256), _mm256_sllv_gfni_epi8(x256, _mm256_sub_epi8(_mm256_set1_epi32(0x08080808), y256)));
	__m256i test256	= _mm256_xor_si256(x256, _mm256_or_si256(_mm256_sllv_gfni_epi8(temp256, y256), _mm256_srlv_gfni_epi8(temp256, _mm256_sub_epi8(_mm256_set1_epi32(0x08080808), y256))));
	assert(_mm256_testz_si256(test256, test256));
	...
	printRes("x256                               ", x256);
	printRes("y256                               ", y256);
	printRes("_mm256_sllv_gfni_epi8(x256, y256)  ", _mm256_sllv_gfni_epi8(x256, y256));
	printRes("_mm256_srlv_gfni_epi8(x256, y256)  ", _mm256_srlv_gfni_epi8(x256, y256));

#if defined(__AVX512F__)
	__m256i full256 = _mm256_set1_epi32(0xffffffff);
	printRes("_mm256_maskz_sllv_gfni_epi8        ", _mm256_maskz_sllv_gfni_epi8((__mmask32)0xac35f0a50f, x256, y256));
	printRes("_mm256_mask_sllv_gfni_epi8         ", _mm256_mask_sllv_gfni_epi8(full256, (__mmask32)0xac35f0a50f, x256, y256));
	printRes("_mm256_maskz_srlv_gfni_epi8        ", _mm256_maskz_srlv_gfni_epi8((__mmask32)0xac35f0a50f, x256, y256));
	printRes("_mm256_mask_srlv_gfni_epi8         ", _mm256_mask_srlv_gfni_epi8(full256, (__mmask32)0xac35f0a50f, x256, y256));
	...
	__m512i temp512		= _mm512_or_si512(_mm512_srlv_gfni_epi8(x512, y512), _mm512_sllv_gfni_epi8(x512, _mm512_sub_epi8(_mm512_set1_epi32(0x08080808), y512)));
	__mmask64 test512	= _mm512_cmpeq_epi8_mask(x512, _mm512_or_si512(_mm512_sllv_gfni_epi8(temp512, y512), _mm512_srlv_gfni_epi8(temp512, _mm512_sub_epi8(_mm512_set1_epi32(0x08080808), y512))));
	assert(test512);

	printRes("x512                               ", x512);
	printRes("y512                               ", y512);
	printRes("_mm512_sllv_gfni_epi8(x512, y512)  ", _mm512_sllv_gfni_epi8(x512, y512));
	printRes("_mm512_srlv_gfni_epi8(x512, y512)  ", _mm512_srlv_gfni_epi8(x512, y512));

	__m512i full512 = _mm512_set1_epi32(0xffffffff);
	printRes("_mm512_maskz_sllv_gfni_epi8        ", _mm512_maskz_sllv_gfni_epi8((__mmask64)0xf00faa5533ccff00, x512, y512));
	printRes("_mm512_mask_sllv_gfni_epi8         ", _mm512_mask_sllv_gfni_epi8(full512, (__mmask64)0xf00faa5533ccff00, x512, y512));
	printRes("_mm512_maskz_srlv_gfni_epi8        ", _mm512_maskz_srlv_gfni_epi8((__mmask64)0xf00faa5533ccff00, x512, y512));
	printRes("_mm512_mask_srlv_gfni_epi8         ", _mm512_mask_srlv_gfni_epi8(full512, (__mmask64)0xf00faa5533ccff00, x512, y512));
#endif
#endif
}
...
//---
	__m128i y128 = _mm_set_epi64x(0xfffefdfcfbfaf9f8, 0xf7f6f5f4f3f2f1f0);
	__m256i y256 = _mm256_set_epi64x(0xfffefdfcfbfaf9f8, 0xf7f6f5f4f3f2f1f0, 0x0f0e0d0c0b0a0908, 0x0706050403020100);
	__m512i y512 = _mm512_set_epi64(0xfffefdfcfbfaf9f8, 0xf7f6f5f4f3f2f1f0, 0xefeeedecebeae9e8, 0xe7e6e5e4e3e2e1e0, 0x1f1e1d1c1b1a1918, 0x1716151413121110, 0x0f0e0d0c0b0a0908, 0x0706050403020100);

	for (int retry = 0; retry < maxRetry; retry++) {
		start = serialized_tsc();
		for (int rep = 0; rep < maxRepeat; rep++) {
			x128 = _mm_add_epi8(_mm_rorv_gfni_epi8(x128, y128), x128);
		}
		minres = min(minres, serialized_tsc() - start);
	}
	printf("_mm_rorv_gfni_epi8(x128, y128)        :%8I64d clks min (%016Ix)\r\n", minres, x128.m128i_u64[0]);

	minres = ULONG_MAX;
	for (int retry = 0; retry < maxRetry; retry++) {
		start = serialized_tsc();
		for (int rep = 0; rep < maxRepeat; rep++) {
			x256 = _mm256_add_epi8(_mm256_rorv_gfni_epi8(x256, y256), x256);
		}
		minres = min(minres, serialized_tsc() - start);
	}
	printf("_mm256_rorv_gfni_epi8(x256, y256)     :%8I64d clks min (%016Ix)\r\n", minres, x256.m256i_u64[0]);

	minres = ULONG_MAX;
	for (int retry = 0; retry < maxRetry; retry++) {
		start = serialized_tsc();
		for (int rep = 0; rep < maxRepeat; rep++) {
			x512 = _mm512_add_epi8(_mm512_rorv_gfni_epi8(x512, y512), x512);
		}
		minres = min(minres, serialized_tsc() - start);
	}
	printf("_mm512_rorv_gfni_epi8(x512, y512)     :%8I64d clks min (%016Ix)\r\n", minres, x512.m512i_u64[0]);

	minres = ULONG_MAX;
	for (int retry = 0; retry < maxRetry; retry++) {
		start = serialized_tsc();
		for (int rep = 0; rep < maxRepeat; rep++) {
			x128 = _mm_add_epi8(_mm_mask_rorv_gfni_epi8(x128, k16, x128, y128), x128);
		}
		minres = min(minres, serialized_tsc() - start);
	}
	printf("_mm_mask_rorv_gfni_epi8(x128, y128)   :%8I64d clks min (%016Ix)\r\n", minres, x128.m128i_u64[0]);

	minres = ULONG_MAX;
	for (int retry = 0; retry < maxRetry; retry++) {
		start = serialized_tsc();
		for (int rep = 0; rep < maxRepeat; rep++) {
			x256 = _mm256_add_epi8(_mm256_mask_rorv_gfni_epi8(x256, k32, x256, y256), x256);
		}
		minres = min(minres, serialized_tsc() - start);
	}
	printf("_mm256_mask_rorv_gfni_epi8(x256, y256):%8I64d clks min (%016Ix)\r\n", minres, x256.m256i_u64[0]);

	minres = ULONG_MAX;
	for (int retry = 0; retry < maxRetry; retry++) {
		start = serialized_tsc();
		for (int rep = 0; rep < maxRepeat; rep++) {
			x512 = _mm512_add_epi8(_mm512_mask_rorv_gfni_epi8(x512, k64, x512, y512), x512);
		}
		minres = min(minres, serialized_tsc() - start);
	}
	printf("_mm512_mask_rorv_gfni_epi8(x512, y512):%8I64d clks min (%016Ix)\r\n", minres, x512.m512i_u64[0]);
...
void GFNI_Demo(void) {
	...
	cout << "-----------------------------------" << endl;
	GFNI_Demo_rotatev_epi8();
	cout << "-----------------------------------" << endl;
	GFNI_Demo_shiftv_epi8();
	cout << "-----------------------------------" << endl;
